...
int CEyedeaInterface::Calibration_StandAlone_Y_Direction(int Direction)
{
	...
	char command = COMMAND_CALIB_STANDALONE_SET_DIRECTION;

	int len = 4;
	unsigned char* data = new unsigned char[len];

	//index
	data[0] = (Direction & 0xFF000000) >> 24;
	data[1] = (Direction & 0x00FF0000) >> 16;
	data[2] = (Direction & 0x0000FF00) >> 8;
	data[3] = (Direction & 0x000000FF);
